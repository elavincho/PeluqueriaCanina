...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        //Hay que pasar como parametro los valores de la mascota anterior
        //Asi puede obtener la Id
        control.modificarMascota(masco, nombreMascota, raza, color, nombreDuenio, celDuenio, observacion, alergico, atencionEspecial);

        mostrarMensaje("Se Modifico Correctamente!!", "Info", "Modificacion Exitosa!!");
        //Cargamos de nuevo la pantalla VerDatos
    ...
    private void cargarDatos(int num_cliente) {
        //Teniendo una variable global se puede pasar los valores de la mascota anterior
        ...
        txtNombreDueno.setText(masco.getDuenio().getNombre());
        txtCelDueno.setText(masco.getDuenio().getCelDuenio());
        if (masco.getAlergico().equals("Si")) {
            cmbAlergico.setSelectedIndex(1);
        } else if (masco.getAlergico().equals("No")) {
            cmbAlergico.setSelectedIndex(2);
        } else if (masco.getAlergico().equals("-")) {
            cmbAlergico.setSelectedIndex(0);
        }
        ...
        } else if (masco.getAtencion_especial().equals("-")) {
            cmbAtencionEspecial.setSelectedIndex(0);
        }
